...
# --- 2. SISTEMA DE TRADUÇÃO (DICIONÁRIO COMPLETO) ---
# Todas as chaves foram verificadas para evitar KeyError
TEXTS = {
    "header_title": {
...
<style>
    ...
    /* Compactar um pouco o topo da sidebar */
    ...
    /* RODAPÉ DA SIDEBAR (Preto/Cinza Escuro) */
    .sidebar-footer {
        margin-top: 20px;
        padding-top: 15px;
    ...
    .sidebar-footer strong {
        color: #111827; /* Preto quase absoluto para destaque */
    }
...
def calcular_pcr_biologico(sequencia, fwd_seq, rev_seq, eh_circular):
    ...
    # --- LÓGICA BIOLÓGICA (3' SEED) - A que você confia ---
    SEED_SIZE = 15
...
with st.sidebar:
    ...
    # Uso a chave 'sidebar_theme' que agora existe no TEXTS para evitar KeyError
...
if any(dados_para_plotar):
    ...
    # CORREÇÃO EIXO Y (FLUTUANTE) - 25pb de margem inferior
    min_view = 25 
    ...
    for i, bands in enumerate(dados_para_plotar):
        ...
        for (tam_aparente, tipo_banda, tam_real) in lista_bandas:
            ...
            if eh_ladder:
                ...
                if type == "Supercoiled": fracao = 0.7
                elif type == "Nicked (Relaxed)": fracao = 0.3
